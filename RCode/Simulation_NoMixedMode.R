...
kernel <- function(position, smoothingLength, dimensions)
{
  ch <- switch(
    dimensions,
    1.0/(6.0* smoothingLength),
    5.0/(14.0 * pi * smoothingLength^2),
    1.0/(4.0 * pi * smoothingLength^3)
  )
  ...
  if(q >= 0.0 && q < 1.0)
  {
    return (ch *((2.0-q)^3.0 - 4.0*(1.0-q)^3.0))
  } 
  else if(q >= 1.0 && q < 2.0)
  {
    return (ch * (2.0-q)^3.0)
...
gradKernel <- function(position, smoothingLength,dimensions)
{
  ...
  if(q >= 0.0 && q < 1.0)
  {
    return (ch * (1.0/smoothingLength) * (-3.0*(2.0-q)^2.0 + 12.0*(1.0-q)^2.0) * unitR)
  } 
  else if(q >= 1.0 && q < 2.0)
  {
    return (ch * (1.0/smoothingLength) * (-3.0*(2.0 - q)^2.0) * unitR)
  }
  else if(q >= 2.0)
  {
    return(0)
